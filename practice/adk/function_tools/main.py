...
async def main():
    ...
    # 1. Pre-Sample Interaction (Triggers tool execution)
    print("--- Pre-Sample Interaction ---")
    pre_sample_prompt = "Can you check the current health status of switch-02?"
