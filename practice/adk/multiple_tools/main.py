...
# Suppress SDK warnings for clean terminal output
...
async def main():
    ...
    # 1. Pre-Sample Interaction (Triggers dynamic multi-tool selection)
    print("--- Pre-Sample Interaction ---")
    pre_sample_prompt = "Check if we have laptops in stock, and calculate tax on a $1200 order."
