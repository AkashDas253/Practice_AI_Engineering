...
async def main():
    ...
    # 1. Pre-Sample Interaction (Triggers ToolContext extraction)
    print("--- Pre-Sample Interaction ---")
    pre_sample_prompt = "What are my current system permissions and active role for this session?"
